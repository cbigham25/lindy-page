            ...
            <div className="container-home">
                ...
                <div className="sib-form" style={{ textAlign: "center", backgroundColor: "#2b2c28" }}>
                    <div id="sib-form-container" className="sib-form-container">
                        ...
                        <div></div>
                        <div id="sib-container" className="sib-container--large sib-container--vertical" style={{ textAlign: "center", backgroundColor: "rgba(255,249,249,1)", maxWidth: "540px", borderRadius: "15px", borderWidth: "1px", borderColor: "#af0b08", borderStyle: "solid", direction: "ltr" }}>
                            <form id="sib-form" method="POST" action="https://e96b05a1.sibforms.com/serve/MUIFANkmn_Vvlnw3PFZyhx8P_APCwUR4u2RZlCePvPWyNUSeoaK4RxSfVjU3siqp1qA_Zw0EgpSPSea2VJ1fSuEHlicS9gmeS6wAmSqub5Lpfn1TOxzjmW-OWIePe4pNI36MAB8W75gwe4LUX3vmj6iYIzEzu3kM0RkLYqwqPOYFL--eCKCViEIc6n1VWDbi77vjdnjhASpWoE0H" data-type="subscription">
                                ...
                                <div style={{ padding: "8px 0" }}>
                                    <div className="sib-form-block sib-divider-form-block">
                                        <div style={{ border: "0", borderBottom: "3px solid #af0b08" }}></div>
                                    </div>
                                </div>
                                <div style={{ padding: "8px 0" }}>
                                ...
                                <div style={{ padding: "8px 0" }}>
                                    <div className="sib-form-block" style={{ textAlign: "left" }}>
                                        <button className="sib-form-block__button sib-form-block__button-with-loader" style={{ fontSize: "16px", textAlign: "left", fontWeight: 700, fontFamily: "Helvetica, sans-serif", color: "#FFFFFF", backgroundColor: "#af0b08", borderRadius: "3px", borderWidth: "0px" }} form="sib-form" type="submit">
